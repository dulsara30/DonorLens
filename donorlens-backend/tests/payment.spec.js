...
test.describe("Payment API", () => {
  ...
  test("make successfull payment with the correct details", async ({
    request,
  }) => {
  ...
  test("try to access the transaction details from normal user login", async ({
    request,
  }) => {
  ...
  test("try to access the transaction details from admin user login", async ({
    request,
  }) => {
    const res = await request.get("payment", {
      headers: {
